...
# Choose the specific CWE that you want to check for cross-type performance
...
random_cwes = ['CWE-264', 'CWE-189', 'CWE-399', 'CWE-200', 'CWE-190'] # CWEs with a substantial amount of instances in the test data
test_data = test_data[test_data["CWE"].isin(random_cwes)]
